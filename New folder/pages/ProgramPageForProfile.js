...
import SectionProgramForProfile from '../components/section_program_for_profile';


const ProgramPageForProfile = () => {
  ...
  return (
    ...
    <div>
       ...
       <SectionProgramForProfile ImageBox={image} name={name} description={description} NumberOfCompletedDays={completedDays} totalDays={totalDays} id={id} completedDays={completedDays}/>
...
export default ProgramPageForProfile;
