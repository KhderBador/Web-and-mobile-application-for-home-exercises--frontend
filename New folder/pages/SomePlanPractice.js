...
const SomePlanPractice = () => {
  ...
  if( counterOfIDInc<=numeberOfSteps){
    ...
    console.log(id)
    axios
      .get(apiUrl+"/somePlanExercises/" + id)
      .then(
        (res) => {
    ...
    navigate('/finishallplanpractises',{state:{planid,dayid}})
...
export default SomePlanPractice;
