...
//     <div id ="form_section">
//   <div class="container">
//     <TitleHead Tiltle="enter your information"/>
  
//     <div class="row">
//       <div class="col-md-5">
//         <img src="images/t3.jpg" alt="" class="img_profile "/ >
//       </div>
//       <div class="col-md-7" >
...
//             </div>
//             <div class="form-group">
//               <label for="">Re_enter your password:</label>
//               <input type="text" class="form-control"/>
//             </div>
//             <div class="form-group">
//               <label for="">choose your photo:</label>
//             <button class="btn">  <input type="file" class="form-control"/></button>
//             </div>
